...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\rss1092j08s.exe" -Parameters "/s /a /s /f1c:\setup.iss" -WindowStyle "Hidden" -PassThru
		...
		##Execute-Process -Path "$envProgramFiles\Internet Explorer\iexplore.exe" -Parameters "Hidden" "http://localhost:1947" -NoWait
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$dirFiles\rss1092j08s.exe" -Parameters "/s /a /s /uninst /f1c:\uninstall.iss" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwZQgSK1Qr0/SjRzwFeT8tErs
# xKmgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFK1mDVVU57TzQDqf0OmKJr8XzdRTMA0GCSqGSIb3DQEBAQUABIIBgJlrB4TP
# g3gj8QsSKMzuRc0btoNvwKCmkZS9dS5tRruQ/Sve5IDFs7iQPoK2r7qv+lsEx9eh
# jv9LGYtCAtVByAQypgWoUQCgO1rECMbGKlAKlWJvIZyVBx4d/zUKgSvCmTFVwm8r
# SQJ0ujtekkCbloj5uwM/0M/tBx9TkRw9PyX4MEr2nnMjIs4Dx/5nQbG/zZ/5Sf1n
# 921NTV3RzfG/7w6tPlirBvOu0vs5KUCtO0OVpKb8qqHX3iw88dlRnOKN37ZHk8+R
# nSWEx9BuAjEEFLrUZE+kzIKohtUjkHJKKPGcrqJZEv3Wl78mEkB7mhIVT3QIjCnG
# dkI/5ZLFy33y+whx5oMwvMpHAGAoYDdnhYkANXera8+/XpOeksnD1EYQ4ODytrA+
# oQBcS3pr0ujkH+bpTrtQxWKHojM89g45wZLyFaDtrLe5udv9L+esWMc6Ykdvv/GO
# nE6oTAFvjZJsvhCGZXI0Ewa1FQKRAGBzyMdnpx+gpXhvZwNBEbsTDxcp8g==
